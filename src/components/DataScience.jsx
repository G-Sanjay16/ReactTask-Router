    ...
    <div className="container">
      <div className="row row-cols-1 row-cols-md-3 g-4">
          ...
          <div className="card h-100">
            ...
            <div className="card-body">
              <h5 className="card-title">
                Top 10 High Paying Non-Coding Jobs in Data Science in 2025
              </h5>
              <p className="card-text">
                Are you someone who’s not interested in coding, but wants to get
                placed in tech through data science, and earn a handsome salary?
            ...
            <div className="card-footer">
              <small className="text-body-secondary">28 November 2024</small>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card h-100">
            <img
              src="https://www.guvi.in/blog/wp-content/uploads/2023/11/Feature-image-1-2048x1024.webp"
              className="card-img-top"
              alt=""
            />
            <div className="card-body">
              <h5 className="card-title">
                Impact of Certification Programs on Hiring Data Scientists
              </h5>
              <p className="card-text">
                Data scientists are the creators behind transforming the raw
                data into edible data insights. These data insights are
                supplements for the growth of modern businesses today.
                <span className="read-more">
                  <strong>READ MORE</strong>
                </span>
              </p>
        ...
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-body">
              <h5 className="card-title">
                Top Product-Based Companies for Data Science Freshers
              </h5>
              <p className="card-text">

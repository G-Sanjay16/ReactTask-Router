      ...
      <div className="row row-cols-1 row-cols-md-3 g-4">
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-footer">
              <small className="text-body-secondary">15 November 2024</small>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                In the world of system design, envision a digital skyscraper – a
                multifaceted structure built to withstand the demands of the
                modern world.
                <span className="read-more">
                  <strong>READ MORE</strong>
                </span>
        ...
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-footer">
              <small className="text-body-secondary">10 November 2024</small>
            </div>
          </div>
        </div>
          ...
          <div className="card h-100">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                sure where to start? We’ll introduce you to a list
            ...
            <div className="card-footer">
              <small className="text-body-secondary">09 November 2024</small>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-body">
              <h5 className="card-title">
                Top 10 Product-Based Companies for Full-Stack Developers [2025]
              </h5>
              <p className="card-text">
                In the dynamic landscape of technology, full-stack developers
                are the architects of the digital world,
            ...
            <div className="card-footer">
              <small className="text-body-secondary">08 November 2024</small>
            </div>
          </div>
        </div>
          <div className="col">
            <div className="card h-100">
              ...
              <div className="card-body">
                <h5 className="card-title">
                  7 Best Full-Stack Development Online Courses [2024]
                </h5>
                <p className="card-text">
                  Today’s world is rapidly evolving into a technological
                  landscape. Owing to these dynamics, scope for
                  full-stack developers are constantly on the rise.
                  <span className="read-more">
                    <strong>READ MORE</strong>
                  </span>
                </p>
              ...
              <div className="card-footer">
                <small className="text-body-secondary">31 August 2024</small>
              </div>
            </div>
          </div>
        </div>
